...
export default function FavoritesPage() {
  const [activeTab, setActiveTab] = useState('candidates'); // default agora mostra candidatos
          ...
          {activeTab === 'jobs' && (
            savedJobs.length > 0 ? (
              ...
              <div className="text-center py-16 bg-white rounded-xl border border-dashed border-gray-300">
                ...
                <Link to="/empresa" className="text-teal-600 hover:underline mt-2 inline-block">Explorar vagas</Link>
              </div>
            )
          )}
        </div>
