...
const mockCandidates = [
    {
        ...
        bio: 'Apaixonada por criar interfaces intuitivas e responsivas. Formada em ADS com foco em React.',
        avatar: 'https://placehold.co/100x100/e8f4f8/000000?text=JL',
        available: true,
    },
    {
        id: 2,
        ...
        bio: 'Especialista em arquitetura de software escalável com mais de 10 anos de experiência.',
        avatar: 'https://placehold.co/100x100/f0fdf4/000000?text=RA',
        available: false,
    },
    {
        id: 3,
        ...
        bio: 'Foco em experiência do usuário e acessibilidade. Transição de carreira do Marketing para Tech.',
        avatar: 'https://placehold.co/100x100/fdf2f8/000000?text=MC',
        available: true,
    },
    {
        id: 4,
        ...
        skills: ['Python', 'Spark', 'SQL', 'ETL', 'Azure'],
        bio: 'Transformando dados brutos em insights valiosos para negócios.',
        avatar: 'https://placehold.co/100x100/fffbeb/000000?text=LP',
        available: true,
    },
];
                ...
                <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-teal-600 font-medium">{candidate.role}</p>
                        </div>
                    </div>
                    <button
...
export default function CandidatePage() {
   ...
   const toggleSelection = (item, list, setList) => {
    ...
    const applyFilters = () => {
        let results = mockCandidates.slice();
                ...
                <div className="bg-blue-900 py-12">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h1 className="text-3xl font-extrabold text-white sm:text-4xl">
                            Encontre o talento ideal para sua empresa
                        </h1>
                        <p className="mt-4 text-xl text-blue-100 max-w-2xl mx-auto">
                            Explore nossa base de profissionais qualificados e filtre pelas habilidades que você precisa.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="w-full lg:w-3/4 xl:w-4/5 space-y-6">
                            <div className="flex justify-between items-center">
                                <h2 className="text-xl font-semibold text-gray-900">
                                    {filteredCandidates.length} Profissionais encontrados
                                </h2>
